eNetXplorer <- function(x, y, family=c("gaussian","binomial","multinomial","cox"),
    ...
    QF.FUN=NULL, QF_label=NULL, cor_method=c("pearson","kendall","spearman"), fold.FUN=generateFoldID, 
    ...
    ...)
{
    ...
    if (family=="gaussian") {
        ...
        n_perm_null=n_perm_null, save_lambda_QF_full=save_lambda_QF_full, QF.FUN=QF.FUN, QF_label=QF_label, cor_method=match.arg(cor_method), fold.FUN=fold.FUN, ...)
